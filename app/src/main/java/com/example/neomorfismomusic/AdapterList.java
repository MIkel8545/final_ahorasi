...
public class AdapterList extends ArrayAdapter<artistas> {

    private Context mContext;
    private int mResource;

    public AdapterList(@NonNull Context context, int resource, @NonNull ArrayList<artistas> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        artista.setText("");
        image.setImageResource(getItem(position).getImg());
        return convertView;
    }
}
